    ...
    <div class="container">
        <div class="row pt-5 justify-content-center align-items-center">
            ...
            <div class="text-center">
                <h6 class="text-lemon">Доставка и</h6>
                <h6 class="text-lemon">оплата</h6>
            </div>
        ...
        <div class="mt-5 mb-3 text-center p-5">
            <h4>Доставка осуществляется в течении 30 - 60 мин</h4>
            <p class="h6">Оплата при получении товара</p>
        </div>
