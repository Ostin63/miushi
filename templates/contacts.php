<div>
    <div class="container">
        <div class="row justify-content-center pt-5">
            ...
            <h2 class="text-lemon">Контакты</h2>
        ...
        <div class="row justify-content-around pt-5">
            ...
            <div class="">
                <p class="h5 pb-3 m-0">г. Курск, ул.Ленина, д.3</p>
                <p class="h5 pb-3 m-0">78003332222@yandex.ru</p>
                <a class="nav-link text-dark h5 p-0 m-0" href="">+7 (800) 333 2 222<br><small class="h6">Работаем
                        с 11.00 до 23.00</small></a>
            </div>
        </div>
